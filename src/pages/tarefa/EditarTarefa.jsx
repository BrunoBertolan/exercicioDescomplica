    ...
    <Grid container spacing={2}>
      <Card sx={style}>
        <CardHeader
          ...
          sx={{ backgroundColor: '#2196f3', color: '#ffffff' }}  // Header style
        />
        <CardContent sx={{ width: '95%', maxWidth: '100%', padding: '16px', backgroundColor: '#f5f5f5' }}>  // Card content style
          <Grid item xs={12}>
            ...
            <Grid item xs={3}>
              <FormControl fullWidth margin="normal">
                ...
                <Input
                  ...
                  sx={{ color: 'rgba(0, 0, 0, 0.87)' }}  // Input style
                />
            ...
            <Grid item xs={3}>
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  size="small"
                  sx={{ color: 'rgba(0, 0, 0, 0.87)' }}  // Select style
                >
